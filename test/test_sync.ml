...
let test_download_image _ =
  let test_session = create_test_session () |> Session.refresh_session_auth in
  let _ = Sync.download_image test_session "did:plc:xov3uvxfd4to6ev3ak5g5uxk" "bafkreieva64qpnxs7zmwc6ezo7hatq4d22ot7wqlj4hi24zimjqzoye4wq" "test_image.jpeg" in
